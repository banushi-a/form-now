...
insert into Questions (QuestionId, FormId, QuestionText, RequiresResponse, QuestionWeight) values (3, 3, 'Which was René Magritte’s first surrealist painting?', true, 1);
...
insert into Questions (QuestionId, FormId, QuestionText, RequiresResponse, QuestionWeight) values (6, 6, 'What’s the name of Hagrid’s pet spider?', true, 4);
insert into Questions (QuestionId, FormId, QuestionText, RequiresResponse, QuestionWeight) values (7, 7, 'What’s the heaviest organ in the human body?', false, 6);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (2, 1, '5', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (4, 1, '10', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (5, 2, 'Dark chocolate', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (6, 2, 'Peanut butter', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (7, 2, 'Canned tuna', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (9, 3, 'Not to Be Reproduced', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (10, 3, 'Personal Values', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (11, 3, 'The Lovers', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (13, 4, 'Nick Lachey', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (14, 4, 'Justin Timberlake', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (16, 4, 'AJ McLean', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (17, 5, 'Eiffel Tower', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (19, 5, 'Great Wall of China', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (20, 5, 'Colosseum', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (21, 6, 'Nigini', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (22, 6, 'Crookshanks', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (24, 6, 'Mosag', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (25, 7, 'Brain', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (26, 7, 'Liver', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (28, 7, 'Heart', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (29, 8, 'Kevin Durant', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (30, 8, 'JJ Reddick', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (32, 8, 'Kyle Korver', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (33, 9, 'Poland', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (34, 9, 'Denmark', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (35, 9, 'Sweden', true);
...
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (38, 10, 'Miami', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (39, 10, 'San Francisco', true);
insert into MCQuestionPossibilities (MCQuestionPossibilityId, MCQuestionId, MCQuestionPossibilityText, MCQuestionCorrect) values (40, 10, 'Austin', true);
